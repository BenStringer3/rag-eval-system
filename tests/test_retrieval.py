...
class TestRetrieval:
    ...
    def test_contextual_precision(self, pipeline: RAGPipeline, eval_dataset_path: str):
    ...
    def test_contextual_recall(self, pipeline: RAGPipeline, eval_dataset_path: str):
